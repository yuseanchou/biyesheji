				...
				<div class="container">
					...
					<div class="collapse navbar-collapse"
						...
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="luoyang.jsp">魅力都江堰</a></li>
							<li><a href="travel.jsp">热门资讯</a></li>
							<li><a href="info.jsp">历史</a></li>
						</ul>
						<!-- 全站搜索 -->
						...
						&nbsp;
						<!-- 天气预报插件-->
						<iframe width="300" height="50" frameborder="0" 
						scrolling="no" hspace="0" src="https://i.tianqi.com/?c=code&
						a=getcode&id=10&py=chongqing&icon=1"></iframe>
					</div>
					<!-- /.navbar-collapse -->
				</div>
				<!-- /.container-fluid -->
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="col-md-7 col-sm-7">
								...
								<div class="intro-text">
									<span class="luoyang"></span> 位于河南省西部、黄河南岸，由周公营建，建于公元前12世纪，是八大古都和国务院首批公布的历史文化名城之一，是中国历史上唯一被命名为“神都”的城市，因地处古洛水之北岸而得名，以为中心的河洛地区是华夏文明的重要发祥地。 从中国第一个王朝夏朝开始、先后有商、西周、东周、东汉、曹魏、西晋、北魏、隋、唐、后梁、后唐、后晋“十三个”朝代在此建都有105位帝王定鼎九州，是华夏民族的精神故乡，是“最早的中国” 。
									<p class="feature">是中国历史上唯一被命名为“神都”的城市，是中国优秀旅游城市和“感动世界的中国品牌城市”。因地处古洛水之北岸而得名，以为中心的河洛地区是华夏文明的重要发祥地。</p>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12 foods text-center">
							<img alt="" src="public/img/shuixi.jpg" class="img-rounded col-md-5 col-md-offset-1" title="水席" style="margin-bottom: 20px;">
