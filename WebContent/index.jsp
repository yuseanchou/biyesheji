...
<!-- 				<li data-target="#myCarousel" data-slide-to="4" onclick="linkGo(4,this)"></li> -->
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					...
					<img class="first-slide" id="banner-img" src="image/banner/轮播图3.jpg" alt="" title="">
					</a>
				</div>
			</div>
		...
		<!-- 景点展示结束-->
			<p style="text-align: center;font-size: 30px;">走近青城山</p>
		...
		<div class="info-show">
			<div class="container">
				...
				<p class="center-block text-center more" style="height: 130px;">
		...
		<!-- 资讯展示结束INFO-->
		<p style="margin: 90px 0 30px;text-align: center; font-size: 20px;"> 友情链接</p>
						...
						<div class="col-md-6 arround center-block">
							...
							<ul class="arround-scen">
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="http://www.hnsxly.com.cn/" target="_blank" class="ts">都江堰</a>
								</li>
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="http://www.lclvyou.com/" target="_blank" class="ts">灌县</a>
								</li>
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="http://www.luoninglyw.com/" target="_blank" class="ts">虹口</a>
								</li>
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="www.baidu.com" target="_blank" class="ts">翠月湖</a></li>
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="http://www.mjlvyou.cn/" target="_blank" class="ts">茶溪谷</a>
								</li>
								<li class="col-md-3 col-sm-3 col-xs-3"><a
									href="http://www.ryly.gov.cn/" target="_blank" class="ts">华希昆虫</a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="welcome">
			<div class="container-fluid">
				<div class="row">
					...
					<p class="text-center col-md-12  col-sm-12 col-xs-12 welcome-title" style="color:black">
						都江堰 — 欢迎您！</p>
				</div>
			</div>
		</div>
		...
		<div class="back-top">
			<a href="javascript:;" class="top-button"> <img src="public/img/top.png" class="top-img" title="返回顶部" />
			</a>
		</div>
				...
				/*使用for循环模拟SQL里的limit(offset,size)*/		 		
				 $.each(infos,function(index,info){
				 	...
				 	result+="<div class='col-md-6 col-sm-6 infos' ><blockquote class=''>"+
					 			...
					 			"</blockquote>"+
					 		"<div class='col-md-12'>"+
						 		"<p class='col-md-7 info_txt' style='height:135px'>"+info.info_txt+"</p>"+
