				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="index_banner" id="banner_tabs">
							<ul>
								<li>
									<a href=""><img src="image/info/历史背景.jpg" width="100%" height="340px"></a>
								</li>
								<li>
									<a href=""><img src="image/info/历史背景1.jpg" width="100%" height="340px"></a>
								</li>
								<li>
									<a href=""><img src="image/info/历史背景2.jpg" width="100%" height="340px"></a>
								</li>
								<li>
									<a href=""><img src="image/info/历史背景3.jpg" width="100%" height="340px"></a>
								</li>
							</ul>
